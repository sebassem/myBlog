...
images:
  - "http://images.seifbassem.com/myblog/images/Posts/AVD-Orchestration-Groups/banner.png"
...
![Orchetrationgroup](http://images.seifbassem.com/myblog/images/Posts/AVD-Orchestration-Groups/WVD-MEMC2.gif)
...
- 
![Orchetrationgroup](http://images.seifbassem.com/myblog/images/Posts/AVD-Orchestration-Groups/WVD-MEMC3.png)

- Next, we need to add the WVD PowerShell modules for the function to be able to load them automatically

![Orchetrationgroup](http://images.seifbassem.com/myblog/images/Posts/AVD-Orchestration-Groups/WVD-MEMC4.png)
...
-Lastly, the function code would take the resource group, host pool, drain-mode status and session host name as parameters and disable/enable accordingly
 ...
 ![Orchetrationgroup](http://images.seifbassem.com/myblog/images/Posts/AVD-Orchestration-Groups/WVD-MEMC5.png)
...
![Orchetrationgroup](http://images.seifbassem.com/myblog/images/Posts/AVD-Orchestration-Groups/WVD-MEMC6.gif)
...
![Orchetrationgroup](http://images.seifbassem.com/myblog/images/Posts/AVD-Orchestration-Groups/WVD-MEMC7.gif)
...
![Orchetrationgroup](http://images.seifbassem.com/myblog/images/Posts/AVD-Orchestration-Groups/WVD-MEMC8.png)
...
![Orchetrationgroup](http://images.seifbassem.com/myblog/images/Posts/AVD-Orchestration-Groups/WVD-MEMC9.png)

## Create a new Orchestration group that updates one session-host at a time with a specific order

![Orchetrationgroup](http://images.seifbassem.com/myblog/images/Posts/AVD-Orchestration-Groups/WVD-MEMC10.gif)
...
![Orchetrationgroup](http://images.seifbassem.com/myblog/images/Posts/AVD-Orchestration-Groups/WVD-MEMC11.gif)
...
![Orchetrationgroup](http://images.seifbassem.com/myblog/images/Posts/AVD-Orchestration-Groups/WVD-MEMC12.png)

![Orchetrationgroup](http://images.seifbassem.com/myblog/images/Posts/AVD-Orchestration-Groups/WVD-MEMC13.png)
...
![Orchetrationgroup](http://images.seifbassem.com/myblog/images/Posts/AVD-Orchestration-Groups/WVD-MEMC14.png)

![Orchetrationgroup](http://images.seifbassem.com/myblog/images/Posts/AVD-Orchestration-Groups/WVD-MEMC15.png)
...
![Orchetrationgroup](http://images.seifbassem.com/myblog/images/Posts/AVD-Orchestration-Groups/WVD-MEMC16.png)
...
![Orchetrationgroup](http://images.seifbassem.com/myblog/images/Posts/AVD-Orchestration-Groups/WVD-MEMC17.png)

The update has been deployed successfully and the host needs to reboot

![Orchetrationgroup](http://images.seifbassem.com/myblog/images/Posts/AVD-Orchestration-Groups/WVD-MEMC18.png)
...
![Orchetrationgroup](http://images.seifbassem.com/myblog/images/Posts/AVD-Orchestration-Groups/WVD-MEMC19.png)

The session host "CMpool1-2" can now accept new sessions after being successfully patched

![Orchetrationgroup](http://images.seifbassem.com/myblog/images/Posts/AVD-Orchestration-Groups/WVD-MEMC20.png)
...
![Orchetrationgroup](http://images.seifbassem.com/myblog/images/Posts/AVD-Orchestration-Groups/WVD-MEMC21.png)

![Orchetrationgroup](http://images.seifbassem.com/myblog/images/Posts/AVD-Orchestration-Groups/WVD-MEMC22.png)
